...
-- --------------------------------------------------------------------------------
function EasyBox2d:destroyBody(item)
   self.w:destroyBody(item.body)
end
...
-- --------------------------------------------------------------------------------
function EasyBox2d:addEdge(t)
   local o = EasyEdge.new(self,t)
   self:addObject(o)
   return o
end
...
function EasyBox2d:createStageWalls(t)
   ...
   local width  = application:getContentWidth()/self.scale
   local height = application:getContentHeight()/self.scale
